              ...
              >
                {discountPercent > 0 && (
                  <div className="absolute top-1 left-1 z-10">
                    <div className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full text-[9.5px] sm:text-xs font-bold shadow-sm">
                      -{discountPercent}% OFF
                    </div>
                  </div>
                )}
                    ...
                    {voucher.stockQuantity === 0 ? (
                      ...
                      <div className="flex flex-col gap-2">
                        <button
                          ...
                          className="w-full bg-amber-400 hover:bg-amber-500 text-gray-900 font-semibold py-2.5 px-4 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer text-xs sm:text-sm"
                        >
                          Buy Now
                        </button>
                        <button
