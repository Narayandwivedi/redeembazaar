      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
          ...
          <div className="relative w-full md:max-w-md group">
            ...
            />
            <button className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-amber-400 hover:bg-amber-500 text-gray-900 font-semibold px-4 py-1.5 rounded-lg transition-colors text-sm shadow-sm flex items-center gap-1 cursor-pointer">
              Search
            </button>
          </div>
        </div>
