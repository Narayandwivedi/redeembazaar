          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                { label: 'X', href: 'https://x.com/redeemkart', icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg> },
              ].map(({ label, href, icon }) => (
                <a
                  key={label}
                  href={href}
            ...
            <ul className="space-y-3 mb-5">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+916746546864" className="text-gray-300 text-sm hover:text-violet-500 transition-colors">+91 67465 46864</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center" style={{ background: 'rgba(139,92,246,0.12)' }}>
